...
**A comprehensive open-source platform for referencing companies linked to investment funds and influential networks**
...
B-Spot is an open-source transparency platform that documents and makes accessible the network of companies funded by investment funds and their connections to influential networks. Our mission is to provide citizens, researchers, and journalists with tools to understand the economic and ideological networks shaping society.
...
This is a **public monorepo** containing the complete B-Spot platform with both frontend and backend components.
...
- **Discussions**: Join community discussions on [GitHub Discussions](https://github.com/Bspot-api/b-spot/discussions)
