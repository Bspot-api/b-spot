...
### Better-Auth Core Tables (managed by `better-auth-mikro-orm`)

These four tables are required by Better-Auth. They are defined as MikroORM entities and managed via MikroORM migrations.
...
|---|---|---|---|
| `id` | `text` PK | NOT NULL | UUID v7, generated by app |
