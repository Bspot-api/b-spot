...
export class Migration20250817111458 extends Migration {
  override async up(): Promise<void> {
    ...
    this.addSql(
      `alter table "personalities" alter column "description" set not null;`,
    );
    ...
    this.addSql(
      `alter table "sectors" alter column "description" set not null;`,
    );
  ...
  override async down(): Promise<void> {
    ...
    this.addSql(
      `alter table "personalities" alter column "description" drop not null;`,
    );
    ...
    this.addSql(
      `alter table "sectors" alter column "description" drop not null;`,
    );
