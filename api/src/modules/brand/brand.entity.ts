...
export class Brand {
  ...
  @ApiProperty({ description: 'Parent company that owns this brand', required: false })
  @ManyToOne(() => Company, { nullable: true })
  company?: Company;

  @ApiProperty({ description: 'Fund that controls this brand', required: false })
  @ManyToOne(() => Fund, { nullable: true })
  fund?: Fund;

  @ApiProperty({ description: 'Primary sector this brand operates in', required: false })
