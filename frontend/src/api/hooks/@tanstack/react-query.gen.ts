 ...
 */
export const authControllerGetProfileOptions = (options?: Options<AuthControllerGetProfileData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
